...
사용자는 매일 저녁 오늘 하루의 AI 관련 뉴스/정보를 모아 오리지널 미소녀 뉴스 큐레이터 `아리아`가 말풍선으로 설명하는 만화형 카드뉴스 이미지로 받고 싶어 한다. 최종 목표는 카드뉴스 이미지를 카카오톡 `나와의 채팅`으로 자동 전송하는 것이다.

## 사용자가 원하는 최종 결과

- 매일 저녁 오늘 하루 AI 소식 요약
